...
void SeamlessClone::set_A()
{
    ...
    for (int i = 0; i < mask_size; i++)
    {
        ...
        triplet_list.emplace_back(i, i, 4.0);
...
void SeamlessClone::set_B()
{
    ...
    for (int type = 0; type < 3; type++)
    {
        ...
        for (int i = 0; i < mask_size; i++)
        {
            ...
            double value = 4 * g(x, y, type) - g(x, y - 1, type) - g(x, y + 1, type) 
                    - g(x - 1, y, type) - g(x + 1, y, type);
