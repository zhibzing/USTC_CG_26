...
<img title="" src="images/README/2026-05-18-15-37-39-image.png" alt="" data-align="center">
...
节点图如下，只需要将上一个节点图 `Set Vertex Color`节点的输出连接到`Points to Mesh`的`Points`输入即可，如橙色框所示。注意红框中的参数，你需要自己调整，使得表面被正常重建出。

<img src="images/README/2026-05-18-15-40-35-image.png" title="" alt="" data-align="center">
